...
class TenantProvisiongService(BaseStack):
    ...
    def _sync_cfn_template_s3_bucket(self) -> None:
        ...
        self._template_path: str = "amc_quickstart/microservices/tenant_provisioning_service"
    ...
    def _create_lambdas(self,microservice, team, environment_id):
        ...
        self._customer_config_ddb_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "tenant_provisioning_service/lambdas/tps/customer_config_ddb")),
        ...
        self._lambda_amc_instance_setup = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "tenant_provisioning_service/lambdas/tps/amc_instance_setup")),
            handler="handler.lambda_handler",
    ...
    def _create_amc_onboarding_sm(self, microservice, team, environment_id):
        ...
        self._add_amc_instance = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "tenant_provisioning_service/lambdas/tps/add_amc_instance")),
            handler="handler.lambda_handler",
        ...
        self._add_amc_instance_check = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "tenant_provisioning_service/lambdas/tps/add_amc_instance_check")),
            handler="handler.lambda_handler",
        ...
        self._amc_instance_post_deploy_metadata = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "tenant_provisioning_service/lambdas/tps/amc_instance_post_deploy_metadata")),
            handler="handler.lambda_handler",
            description="Onboard AMC into environment",
            timeout=cdk.Duration.minutes(10),
            memory_size=512,
