...
class WorkFlowManagerService(BaseStack):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._wfm_helper_layer = LayerVersion(
            self,
            "WFMHelperLayer",
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambda-layers/wfm-layer/")),
    ...
    def _create_lambdas(self, function_name_prefix):
        ...
        lambda_sync_workflow_status = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/sync_workflow_status")),
        ...
        LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/generate_data_range")),
            handler="handler.lambda_handler",
        ...
        LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/generate_execution_resubmission")),
            handler="handler.lambda_handler",
        ...
        workflow_status_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/workflow_status_trigger")),
            handler="handler.lambda_handler",
        ...
        self._lambda_amc_api_interface = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/amc_api_interface")),
            handler="handler.lambda_handler",
        ...
        workflow_table_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/workflow_table_trigger")),
            handler="handler.lambda_handler",
        ...
        self._execution_queue_consumer = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/workflow_queue_consumer")),
            handler="handler.lambda_handler",
        ...
        lambda_events_queue_producer = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/execution_queue_producer")),
            handler="handler.lambda_handler",
        ...
        workflow_schedule_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/workflow_schedule_trigger")),
            handler="handler.lambda_handler",
        ...
        workflow_library_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/workflow_library_trigger")),
            handler="handler.lambda_handler",
        ...
        customer_config_trigger = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/customer_config_trigger")),
            handler="handler.lambda_handler",
        ...
        self._lambda_custom_scheduler = LambdaFactory.function(
            ...
            code=Code.from_asset(os.path.join(f"{Path(__file__).parents[1]}", "workflow_management_service/lambdas/custom_scheduler")),
            handler="handler.lambda_handler",
