...
class CustomerInterface():
    ...
    def set_customer_config(TEAM_NAME, ENV, customerId: str, customerConfig: dict):
        '''
        ...
        customer_table_name = f'wfm-{TEAM_NAME}-CustomerConfig-{ENV}'
    ...
    def delete_customer(self, customerId: str):
        '''
        Deletes a customer from the WFM-CustomerConfig table
        '''
